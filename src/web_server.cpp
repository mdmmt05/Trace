  ...
  <footer>
    ...
    <div class="monogram">
      <svg width="128" height="128" viewBox="0 0 1254 1254" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <!-- <circle cx="16" cy="16" r="13" stroke="#c8aa7a" stroke-width="0.8" fill="none"/>
        <text x="16" y="21" text-anchor="middle" font-family="Georgia, serif" font-size="12" fill="#c8aa7a" font-style="italic">M</text> -->
      </svg>
    </div>
    <!-- /MONOGRAM SVG PLACEHOLDER -->
  </footer>
